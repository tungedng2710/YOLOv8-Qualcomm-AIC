...
class_names = ['xe buyt', 'o to', 'xe may', 'xe tai', 'xe dap']
...
def is_video_file(file_path):
    """ Determine the video file type based on its extension """
...
def is_image_file(file_path):
    """ Determine the image file type based on its extension """
    video_extensions = ['.jpg', '.jpeg', '.png', '.tiff']
